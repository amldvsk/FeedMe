...
@WebServlet(name = "ManagerRegistrationServlet", urlPatterns = {"/ManagerRegistrationServlet"})
public class ManagerRegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       /* String firstName = request.getParameter("firstName");
         ...
         if(result)
         {
            Manager manager = new Customer(firstName, lastName,userName,pw,phone,email,role,dbId,,day,gender,email,un, userId, pw);
