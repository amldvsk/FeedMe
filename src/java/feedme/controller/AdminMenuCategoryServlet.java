 ...
 * @author adi
 */
@WebServlet(name = "AdminMenuCategoryServlet", urlPatterns = {"/admin/menu-category"})
public class AdminMenuCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher  dispatcher = request.getRequestDispatcher("menu-cat.jsp");
