          ...
          <div class="clearfix">
            <p class="fieldset pull-right" style="margin: 0; width: calc(60% - 5px)">
              ...
              <!--<input class="full-width has-padding has-border" name="city" id="city" type="text"  placeholder="עיר" required>-->
                     <select class="full-width has-padding has-border" name="city" id="city" type="text"  placeholder="עיר" required style="padding: 15px; border: 1px solid #d2d8d8; background-color: transparent; width: 100%; border-radius: 0.25em;">
